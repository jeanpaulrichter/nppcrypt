...
#define     NPPC_CRYPT_AUTH_IVSALT_URL  "https://github.com/jeanpaulrichter/nppcrypt#faq_5"
#define     NPPC_EASYMODE_HELP_URL      "https://github.com/jeanpaulrichter/nppcrypt#faq_9"
